      ...
      <UContainer>
        <div class="max-w-4xl mx-auto">
          <div class="text-center mb-12">
            <h2 class="font-noto text-3xl md:text-4xl font-black text-[#050b14] mb-6 uppercase tracking-tight">Готові запустити ефективний магазин для вашого бізнесу?</h2>

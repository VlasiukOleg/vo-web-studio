        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 relative z-10">
          <div>
            ...
            <div class="flex flex-row gap-8">
              <a href="https://t.me/vl_oleg_frontend" class="inline-flex items-center gap-3 hover:opacity-80 transition-opacity group">
              ...
              <a href="viber://chat?number=380632790437" class="inline-flex items-center gap-3 hover:opacity-80 transition-opacity group">
                ...
                <span class="text-lg font-bold text-white">Viber</span>
              </a>
            </div>
          </div>
...
defineProps({
  title: {
    type: String,
    default: 'Давайте<br/><span class="text-cyan-400">створимо</span><br/>щось цікаве'
  },
  description: {
    type: String,
    default: 'Заповніть форму, або просто напишіть нам у Telegram чи Viber. Ми завжди на зв\'язку і готові обговорити деталі вашого проєкту!'
  }
})
</script>
